...
class ResponseLogic(object):
    def __init__(self, LUIS_ID, LUIS_KEY):
        self.LUIS_ID = LUIS_ID
        ...
        self.variables = {}
        self.decision = None
        self.file_path = 'C:\\Users\\perus\\source\\repos\\' + \
                         'Automated Decision Toolkit\\data'
